...
extension UIImageView {
     ...
     */
    internal convenience init(webPath: String, useBGThread: Bool = true, onError:@escaping OnError = defaultErrorHandler) {
        self.init()
     ...
     */
    internal convenience init(filePath: String) { // should throw?
